...
function alchemy_concoction()
  local lc_inscription = ("I hear voices from the Aether, their song compels me:\nFind %s \ndissolve into a thin slurry, strain it, and catalyse the reaction with a ray of the sun"):format(combos.LC[localized])
  return lc_inscription
end

function alchemy_precursor()
  local ap_inscription = ("I hear voices from the Below, they command me:\nAqcuire %s \nemulsify them, heat the mixture, and catalyse the reaction with a fading soul"):format(combos.AP[localized])
  return ap_inscription
end