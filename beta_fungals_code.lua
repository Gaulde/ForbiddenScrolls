...
MATERIALS_FROM = 
{
    ...
    { probability = 1.0, materials = { "radioactive_liquid", "poison", "material_darkness" }, name_material = "poisonous liquids"},
...
function get_abs_shift(player_entity, iter, convert_tries)
