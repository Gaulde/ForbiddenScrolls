...
function format_relative(curr, index)
    local letters = {"Alpha   :", "Beta    :", "Gamma :", "Delta   :", "Epsilon :"}  -- Add more if needed
    local term = "invalid"
    
    if index >= curr and index <= curr + #letters then
        term = letters[index - curr + 1]
    end
